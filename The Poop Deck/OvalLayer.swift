...
class OvalLayer: CAShapeLayer {
  ...
  var ovalPathSmall: UIBezierPath {
    return UIBezierPath(ovalIn: CGRect(x: CircleSizes.circleSmall, y: CircleSizes.circleSmall, width: 0.0, height: 0.0))
  }
  
  var ovalPathLarge: UIBezierPath {
    return UIBezierPath(ovalIn: CGRect(x: 2.5, y: 17.5, width: CircleSizes.circleLarge, height: CircleSizes.circleLarge))
  }
  
  var ovalPathSquishVertical: UIBezierPath {
    return UIBezierPath(ovalIn: CGRect(x: 2.5, y: 20.0, width: CircleSizes.circleLarge, height: CircleSizes.squishAmount))
  }
  
  var ovalPathSquishHorizontal: UIBezierPath {
    return UIBezierPath(ovalIn: CGRect(x: 5.0, y: 20.0, width: CircleSizes.squishAmount, height: CircleSizes.squishAmount))
  }
